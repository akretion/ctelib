...
#   ('--no-process-includes', '')
#   ('-o', 'ctelib/v3_00/consReciCTeTiposBasico.py')
#
# Command line arguments:
#   schemas/v3_00/consReciCTeTiposBasico_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "ctelib/v3_00/consReciCTeTiposBasico.py" schemas/v3_00/consReciCTeTiposBasico_v3.00.xsd
#
...
class TProtCTe(GeneratedsSuper):
    ...
    def validate_TVerConsReciCTe(self, value):
        # Validate type TVerConsReciCTe, a restriction on xs:string.
        pass
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='TProtCTe', namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TProtCTe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='TProtCTe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TProtCTe'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TProtCTe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            self.validate_TVerConsReciCTe(self.versao)    # validate type TVerConsReciCTe
...
class TConsReciCTe(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TConsReciCTe)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TConsReciCTe.subclass:
            return TConsReciCTe.subclass(*args_, **kwargs_)
        else:
            return TConsReciCTe(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_tpAmb(self): return self.tpAmb
    def set_tpAmb(self, tpAmb): self.tpAmb = tpAmb
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='TConsReciCTe', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TConsReciCTe')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TConsReciCTe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='TConsReciCTe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TConsReciCTe'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))
    def exportChildren(self, outfile, level, namespace_='', name_='TConsReciCTe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpAmb':
            ...
            self.nRec = nRec_
# end class TConsReciCTe


class TRetConsReciCTe(GeneratedsSuper):
    """Tipo Retorno do Pedido de Consulta do Recibo do Lote de CT-e"""
    subclass = None
    superclass = None
    def __init__(self, versao=None, tpAmb=None, verAplic=None, nRec=None, cStat=None, xMotivo=None, cUF=None, protCTe=None):
        self.original_tagname_ = None
        self.versao = _cast(None, versao)
        self.tpAmb = tpAmb
        self.verAplic = verAplic
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TRetConsReciCTe)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TRetConsReciCTe.subclass:
            return TRetConsReciCTe.subclass(*args_, **kwargs_)
        else:
            return TRetConsReciCTe(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_tpAmb(self): return self.tpAmb
    def set_tpAmb(self, tpAmb): self.tpAmb = tpAmb
    def get_verAplic(self): return self.verAplic
    ...
    def add_protCTe(self, value): self.protCTe.append(value)
    def insert_protCTe_at(self, index, value): self.protCTe.insert(index, value)
    def replace_protCTe_at(self, index, value): self.protCTe[index] = value
    def get_versao(self): return self.versao
    def set_versao(self, versao): self.versao = versao
    def validate_TVerConsReciCTe(self, value):
        # Validate type TVerConsReciCTe, a restriction on xs:string.
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='TRetConsReciCTe', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TRetConsReciCTe')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TRetConsReciCTe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='TRetConsReciCTe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TRetConsReciCTe'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))
    def exportChildren(self, outfile, level, namespace_='', name_='TRetConsReciCTe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for protCTe_ in self.protCTe:
            protCTe_.export(outfile, level, namespace_, name_='protCTe', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpAmb':
            ...
            obj_ = TProtCTe.factory()
            obj_.build(child_)
            self.protCTe.append(obj_)
            obj_.original_tagname_ = 'protCTe'
# end class TRetConsReciCTe
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from consReciCTeTiposBasico import *\n\n')
        sys.stdout.write('import consReciCTeTiposBasico as model_\n\n')
