...
#   ('--no-process-includes', '')
#   ('-o', 'ctelib/v3_00/cteModalRodoviarioOS.py')
#
# Command line arguments:
#   schemas/v3_00/cteModalRodoviarioOS_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "ctelib/v3_00/cteModalRodoviarioOS.py" schemas/v3_00/cteModalRodoviarioOS_v3.00.xsd
#
...
class rodoOS(GeneratedsSuper):
    """Informações do modal Rodoviário"""
    subclass = None
    superclass = None
    def __init__(self, TAF=None, NroRegEstadual=None, veic=None):
        self.original_tagname_ = None
        self.TAF = TAF
        self.validate_TTermoAutFreta(self.TAF)
        self.NroRegEstadual = NroRegEstadual
        self.validate_TNroRegEstadual(self.NroRegEstadual)
        self.veic = veic
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, rodoOS)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if rodoOS.subclass:
            return rodoOS.subclass(*args_, **kwargs_)
        else:
            return rodoOS(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_TAF(self): return self.TAF
    def set_TAF(self, TAF): self.TAF = TAF
    def get_NroRegEstadual(self): return self.NroRegEstadual
    def set_NroRegEstadual(self, NroRegEstadual): self.NroRegEstadual = NroRegEstadual
    def get_veic(self): return self.veic
    def set_veic(self, veic): self.veic = veic
    def validate_TTermoAutFreta(self, value):
        # Validate type TTermoAutFreta, a restriction on xs:string.
        pass
    def validate_TNroRegEstadual(self, value):
        # Validate type TNroRegEstadual, a restriction on xs:string.
        pass
    def hasContent_(self):
        if (
            self.TAF is not None or
            self.NroRegEstadual is not None or
            self.veic is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='rodoOS', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('rodoOS')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='rodoOS')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='rodoOS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='rodoOS'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='rodoOS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.TAF is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTAF>%s</%sTAF>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.TAF), input_name='TAF')), namespace_, eol_))
        if self.NroRegEstadual is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNroRegEstadual>%s</%sNroRegEstadual>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.NroRegEstadual), input_name='NroRegEstadual')), namespace_, eol_))
        if self.veic is not None:
            self.veic.export(outfile, level, namespace_, name_='veic', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TAF':
            TAF_ = child_.text
            TAF_ = self.gds_validate_string(TAF_, node, 'TAF')
            self.TAF = TAF_
            # validate type TTermoAutFreta
            self.validate_TTermoAutFreta(self.TAF)
        elif nodeName_ == 'NroRegEstadual':
            NroRegEstadual_ = child_.text
            NroRegEstadual_ = self.gds_validate_string(NroRegEstadual_, node, 'NroRegEstadual')
            self.NroRegEstadual = NroRegEstadual_
            # validate type TNroRegEstadual
            self.validate_TNroRegEstadual(self.NroRegEstadual)
        elif nodeName_ == 'veic':
            obj_ = veic.factory()
            obj_.build(child_)
            self.veic = obj_
            obj_.original_tagname_ = 'veic'
# end class rodoOS


class veic(GeneratedsSuper):
    """Dados do Veículo"""
    subclass = None
    superclass = None
    def __init__(self, placa=None, RENAVAM=None, prop=None, UF=None):
        self.original_tagname_ = None
        self.placa = placa
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, veic)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if veic.subclass:
            return veic.subclass(*args_, **kwargs_)
        else:
            return veic(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='veic', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('veic')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='veic')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='veic', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='veic'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='veic', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class prop(GeneratedsSuper):
    ...
    pertencer à empresa emitente do CT-e OS"""
    subclass = None
    superclass = None
    def __init__(self, CPF=None, CNPJ=None, TAF=None, NroRegEstadual=None, xNome=None, IE=None, UF=None, tpProp=None):
        self.original_tagname_ = None
        self.CPF = CPF
        self.CNPJ = CNPJ
        self.TAF = TAF
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from cteModalRodoviarioOS import *\n\n')
        sys.stdout.write('import cteModalRodoviarioOS as model_\n\n')
