...
#   ('--no-process-includes', '')
#   ('-o', 'ctelib/v3_00/evEPECCTe.py')
#
# Command line arguments:
#   schemas/v3_00/evEPECCTe_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "ctelib/v3_00/evEPECCTe.py" schemas/v3_00/evEPECCTe_v3.00.xsd
#
...
class evEPECCTe(GeneratedsSuper):
    """Schema XML de validação do evento de emissão prévia de emissão em
    contingência 110113"""
    subclass = None
    superclass = None
    def __init__(self, descEvento=None, xJust=None, vICMS=None, vTPrest=None, vCarga=None, toma4=None, modal=None, UFIni=None, UFFim=None, tpCTe=None, dhEmi=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evEPECCTe)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evEPECCTe.subclass:
            return evEPECCTe.subclass(*args_, **kwargs_)
        else:
            return evEPECCTe(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            self.dhEmi is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='evEPECCTe', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/cte"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evEPECCTe')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='evEPECCTe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='evEPECCTe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='evEPECCTe'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='evEPECCTe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class descEvento(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='descEvento', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/cte"', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='descEvento', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='descEvento'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='descEvento', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class toma4(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, toma=None, UF=None, CNPJ=None, CPF=None, IE=None):
        self.original_tagname_ = None
        self.toma = toma
        self.UF = UF
        self.CNPJ = CNPJ
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='toma4', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/cte"', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='toma4', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='toma4'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='toma4', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class toma(GeneratedsSuper):
    """Tomador do ServiçoPreencher com: 0-Remetente;
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='toma', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/cte"', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='toma', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='toma'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='toma', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class tpCTe(GeneratedsSuper):
    """Tipo do CT-e - Aceitar apenas Tipo Normal = 0Preencher com: 0 - CT-e
    Normal; 1 - CT-e de Complemento de Valores; 2 - CT-e de
    Anulação; 3 - CT-e Substituto"""
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tpCTe)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tpCTe.subclass:
            return tpCTe.subclass(*args_, **kwargs_)
        else:
            return tpCTe(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='tpCTe', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/cte"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('tpCTe')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='tpCTe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='tpCTe', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='tpCTe'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='tpCTe', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class dhEmi(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='dhEmi', namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/cte"', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='dhEmi', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='dhEmi'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='dhEmi', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
def parse(inFileName, silence=False):
    ...
    if not silence:
        ...
        rootObj.export(
            ...
            namespacedef_='xmlns:ns1="http://www.portalfiscal.inf.br/cte"',
            pretty_print=True)
    return rootObj
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from evEPECCTe import *\n\n')
        sys.stdout.write('import evEPECCTe as model_\n\n')
