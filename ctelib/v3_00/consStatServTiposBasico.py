...
#   ('--no-process-includes', '')
#   ('-o', 'ctelib/v3_00/consStatServTiposBasico.py')
#
# Command line arguments:
#   schemas/v3_00/consStatServTiposBasico_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "ctelib/v3_00/consStatServTiposBasico.py" schemas/v3_00/consStatServTiposBasico_v3.00.xsd
#
...
class TRetConsStatServ(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TRetConsStatServ', fromsubclass_=False, pretty_print=True):
        ...
        if self.verAplic is not None:
            self.verAplic.export(outfile, level, namespace_, name_='verAplic', pretty_print=pretty_print)
        ...
        if self.dhRetorno is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdhRetorno>%s</%sdhRetorno>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.dhRetorno), input_name='dhRetorno')), namespace_, eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpAmb':
            ...
            obj_ = None
            self.verAplic = obj_
            obj_.original_tagname_ = 'verAplic'
...
class verAplic(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, verAplic)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if verAplic.subclass:
            return verAplic.subclass(*args_, **kwargs_)
        else:
            return verAplic(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='verAplic', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('verAplic')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='verAplic')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='verAplic', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='verAplic'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='verAplic', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from consStatServTiposBasico import *\n\n')
        sys.stdout.write('import consStatServTiposBasico as model_\n\n')
