...
#   ('--no-process-includes', '')
#   ('-o', 'ctelib/v3_00/cteModalRodoviario.py')
#
# Command line arguments:
#   schemas/v3_00/cteModalRodoviario_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "ctelib/v3_00/cteModalRodoviario.py" schemas/v3_00/cteModalRodoviario_v3.00.xsd
#
...
class rodo(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, RNTRC=None, occ=None):
    ...
    def get_occ(self): return self.occ
    def set_occ(self, occ): self.occ = occ
    def add_occ(self, value): self.occ.append(value)
    def insert_occ_at(self, index, value): self.occ.insert(index, value)
    def replace_occ_at(self, index, value): self.occ[index] = value
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='rodo', fromsubclass_=False, pretty_print=True):
        ...
        if self.RNTRC is not None:
            self.RNTRC.export(outfile, level, namespace_, name_='RNTRC', pretty_print=pretty_print)
        for occ_ in self.occ:
            occ_.export(outfile, level, namespace_, name_='occ', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'RNTRC':
            obj_ = None
            self.RNTRC = obj_
            obj_.original_tagname_ = 'RNTRC'
        elif nodeName_ == 'occ':
            obj_ = occ.factory()
            obj_.build(child_)
            self.occ.append(obj_)
            obj_.original_tagname_ = 'occ'
# end class rodo


class RNTRC(GeneratedsSuper):
    """Registro Nacional de Transportadores Rodoviários de CargaRegistro
    obrigatório do emitente do CT-e junto à ANTT para exercer a
    atividade de transportador rodoviário de cargas por conta de
...
class occ(GeneratedsSuper):
    """Ordens de Coleta associados"""
    subclass = None
    superclass = None
    def __init__(self, serie=None, nOcc=None, dEmi=None, emiOcc=None):
        self.original_tagname_ = None
        self.serie = serie
        self.nOcc = nOcc
        self.dEmi = dEmi
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, occ)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if occ.subclass:
            return occ.subclass(*args_, **kwargs_)
        else:
            return occ(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_serie(self): return self.serie
    def set_serie(self, serie): self.serie = serie
    def get_nOcc(self): return self.nOcc
    def set_nOcc(self, nOcc): self.nOcc = nOcc
    def get_dEmi(self): return self.dEmi
    def set_dEmi(self, dEmi): self.dEmi = dEmi
    def get_emiOcc(self): return self.emiOcc
    def set_emiOcc(self, emiOcc): self.emiOcc = emiOcc
    def hasContent_(self):
        if (
            self.serie is not None or
            self.nOcc is not None or
            self.dEmi is not None or
            self.emiOcc is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='occ', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('occ')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='occ')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='occ', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='occ'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='occ', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.nOcc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snOcc>%s</%snOcc>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.nOcc), input_name='nOcc')), namespace_, eol_))
        ...
        if self.emiOcc is not None:
            self.emiOcc.export(outfile, level, namespace_, name_='emiOcc', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'serie':
            ...
            nOcc_ = child_.text
            nOcc_ = self.gds_validate_string(nOcc_, node, 'nOcc')
            self.nOcc = nOcc_
        elif nodeName_ == 'dEmi':
            dEmi_ = child_.text
            dEmi_ = self.gds_validate_string(dEmi_, node, 'dEmi')
            self.dEmi = dEmi_
        elif nodeName_ == 'emiOcc':
            obj_ = emiOcc.factory()
            obj_.build(child_)
            self.emiOcc = obj_
            obj_.original_tagname_ = 'emiOcc'
# end class occ
...
class nOcc(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, nOcc)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if nOcc.subclass:
            return nOcc.subclass(*args_, **kwargs_)
        else:
            return nOcc(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='nOcc', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('nOcc')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='nOcc')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='nOcc', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='nOcc'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='nOcc', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class emiOcc(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, CNPJ=None, cInt=None, IE=None, UF=None, fone=None):
        self.original_tagname_ = None
        self.CNPJ = CNPJ
        self.cInt = cInt
        self.IE = IE
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, emiOcc)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if emiOcc.subclass:
            return emiOcc.subclass(*args_, **kwargs_)
        else:
            return emiOcc(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='emiOcc', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('emiOcc')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='emiOcc')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='emiOcc', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='emiOcc'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='emiOcc', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class cInt(GeneratedsSuper):
    """Código interno de uso da transportadoraUso intermo das
    transportadoras."""
    subclass = None
    superclass = None
    def __init__(self):
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from cteModalRodoviario import *\n\n')
        sys.stdout.write('import cteModalRodoviario as model_\n\n')
