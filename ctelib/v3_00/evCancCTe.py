...
#   ('--no-process-includes', '')
#   ('-o', 'ctelib/v3_00/evCancCTe.py')
#
# Command line arguments:
#   schemas/v3_00/evCancCTe_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "ctelib/v3_00/evCancCTe.py" schemas/v3_00/evCancCTe_v3.00.xsd
#
...
class evCancCTe(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evCancCTe)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evCancCTe.subclass:
            return evCancCTe.subclass(*args_, **kwargs_)
        else:
            return evCancCTe(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='evCancCTe', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evCancCTe')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='evCancCTe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='evCancCTe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='evCancCTe'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='evCancCTe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from evCancCTe import *\n\n')
        sys.stdout.write('import evCancCTe as model_\n\n')
