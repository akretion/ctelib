...
#   ('--no-process-includes', '')
#   ('-o', 'ctelib/v3_00/cteModalDutoviario.py')
#
# Command line arguments:
#   schemas/v3_00/cteModalDutoviario_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "ctelib/v3_00/cteModalDutoviario.py" schemas/v3_00/cteModalDutoviario_v3.00.xsd
#
...
class duto(GeneratedsSuper):
    """Informações do modal Dutoviário"""
    subclass = None
    superclass = None
    def __init__(self, vTar=None, dIni=None, dFim=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, duto)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if duto.subclass:
            return duto.subclass(*args_, **kwargs_)
        else:
            return duto(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='duto', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('duto')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='duto')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='duto', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='duto'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='duto', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from cteModalDutoviario import *\n\n')
        sys.stdout.write('import cteModalDutoviario as model_\n\n')
