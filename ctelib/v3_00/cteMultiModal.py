...
#   ('--no-process-includes', '')
#   ('-o', 'ctelib/v3_00/cteMultiModal.py')
#
# Command line arguments:
#   schemas/v3_00/cteMultiModal_v3.00.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "ctelib/v3_00/cteMultiModal.py" schemas/v3_00/cteMultiModal_v3.00.xsd
#
...
class multimodal(GeneratedsSuper):
    """Informações do Multimodal"""
    subclass = None
    superclass = None
    def __init__(self, COTM=None, indNegociavel=None, seg=None):
        self.original_tagname_ = None
        self.COTM = COTM
        self.indNegociavel = indNegociavel
        self.seg = seg
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, multimodal)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if multimodal.subclass:
            return multimodal.subclass(*args_, **kwargs_)
        else:
            return multimodal(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_COTM(self): return self.COTM
    def set_COTM(self, COTM): self.COTM = COTM
    def get_indNegociavel(self): return self.indNegociavel
    def set_indNegociavel(self, indNegociavel): self.indNegociavel = indNegociavel
    def get_seg(self): return self.seg
    def set_seg(self, seg): self.seg = seg
    def hasContent_(self):
        if (
            self.COTM is not None or
            self.indNegociavel is not None or
            self.seg is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='multimodal', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('multimodal')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='multimodal')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='multimodal', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='multimodal'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='multimodal', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.COTM is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCOTM>%s</%sCOTM>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.COTM), input_name='COTM')), namespace_, eol_))
        if self.indNegociavel is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sindNegociavel>%s</%sindNegociavel>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.indNegociavel), input_name='indNegociavel')), namespace_, eol_))
        if self.seg is not None:
            self.seg.export(outfile, level, namespace_, name_='seg', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'COTM':
            COTM_ = child_.text
            COTM_ = self.gds_validate_string(COTM_, node, 'COTM')
            self.COTM = COTM_
        elif nodeName_ == 'indNegociavel':
            indNegociavel_ = child_.text
            indNegociavel_ = self.gds_validate_string(indNegociavel_, node, 'indNegociavel')
            self.indNegociavel = indNegociavel_
        elif nodeName_ == 'seg':
            obj_ = seg.factory()
            obj_.build(child_)
            self.seg = obj_
            obj_.original_tagname_ = 'seg'
# end class multimodal


class COTM(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, COTM)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if COTM.subclass:
            return COTM.subclass(*args_, **kwargs_)
        else:
            return COTM(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='COTM', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('COTM')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='COTM')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='COTM', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='COTM'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='COTM', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class indNegociavel(GeneratedsSuper):
    """Indicador Negociável Preencher com: 0 - Não Negociável; 1 -
    Negociável"""
    subclass = None
    superclass = None
    def __init__(self):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, indNegociavel)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if indNegociavel.subclass:
            return indNegociavel.subclass(*args_, **kwargs_)
        else:
            return indNegociavel(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='indNegociavel', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('indNegociavel')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='indNegociavel')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='indNegociavel', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='indNegociavel'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='indNegociavel', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class seg(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, infSeg=None, nApol=None, nAver=None):
        self.original_tagname_ = None
        self.infSeg = infSeg
        self.nApol = nApol
        self.nAver = nAver
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='seg', fromsubclass_=False, pretty_print=True):
        ...
        if self.nAver is not None:
            self.nAver.export(outfile, level, namespace_, name_='nAver', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class nAver(GeneratedsSuper):
    """Número da AverbaçãoNão é obrigatório, pois muitas averbações ocorrem
    aapós a emissão do CT, mensalmente, por exemplo."""
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from cteMultiModal import *\n\n')
        sys.stdout.write('import cteMultiModal as model_\n\n')
